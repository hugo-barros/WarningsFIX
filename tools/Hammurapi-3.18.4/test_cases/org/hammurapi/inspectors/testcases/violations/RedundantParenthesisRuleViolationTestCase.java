...
/**
 * RedundantParenthesisRule
 * @author  Pavel Vlasov
 * @version $Revision: 1.1 $
 */
public class RedundantParenthesisRuleViolationTestCase {
	...
	private Vector billItems;

	/** Java doc automaticaly generated by Hammurapi */
	public RedundantParenthesisRuleViolationTestCase() {
		super();
		
		billItems = new Vector(DIM);
