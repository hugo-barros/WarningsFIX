...
:runHammurapi
"%_JAVACMD%" -classpath "%HAMMURAPI_HOME%"\ant.jar;"%LOCALCLASSPATH%" -Dant.home="%HAMMURAPI_HOME%" %HAMMURAPI_OPTS% org.hammurapi.QuickHammurapiTask %HAMMURAPI_ARGS% %HAMMURAPI_CMD_LINE_ARGS%
