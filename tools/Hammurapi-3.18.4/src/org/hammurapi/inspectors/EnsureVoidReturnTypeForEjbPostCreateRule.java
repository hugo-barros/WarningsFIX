 ...
 */
public class EnsureVoidReturnTypeForEjbPostCreateRule extends InspectorBase  {
			...
			if (clazz.isKindOf("javax.ejb.EnterpriseBean")) {
				...
				while (it.hasNext()) {
					...
					if (o instanceof com.pavelvlasov.jsel.Method) {
						...
						if ("ejbPostCreate".equals(method.getName()) && !(method.getReturnType().getType() instanceof Void)) {
