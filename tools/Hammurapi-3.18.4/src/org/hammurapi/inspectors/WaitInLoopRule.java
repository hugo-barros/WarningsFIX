 ...
 */
public class WaitInLoopRule extends InspectorBase  {
	...
	public void visit(MethodCall element) {
		...
		if (methodName instanceof Ident && WAIT.equals(((Ident) methodName).getText()) && (parameters.size()==0 || parameters.size()==1)) {
