...
import com.pavelvlasov.jsel.primitives.Void;
 ...
 */
public class EnsureVoidReturnTypeForSessionBeanEjbCreateRule extends InspectorBase  {
	
	public void visit(com.pavelvlasov.jsel.Class clazz) {
		try {
			if (clazz.isKindOf("javax.ejb.SessionBean")) {
				...
				while (it.hasNext()) {
					...
					if (o instanceof com.pavelvlasov.jsel.Method) {
						...
						if ("ejbCreate".equals(method.getName()) && !(method.getReturnType().getType() instanceof Void)) {
