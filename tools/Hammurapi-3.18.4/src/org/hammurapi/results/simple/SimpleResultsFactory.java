 ...
 */
public class SimpleResultsFactory extends ResultsFactory {		
	private WaiverSet waiverSet;

	public SimpleResultsFactory(WaiverSet waiverSet) {
	...
	public ReviewResults newReviewResults(CompilationUnit compilationUnit) {
		return new SimpleReviewResults(compilationUnit, waiverSet);
	}
