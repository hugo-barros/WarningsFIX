...
CREATE CACHED TABLE PRIMARY_KEY (
...
ALTER TABLE INSPECTOR
  ADD CONSTRAINT FK_INSPECTOR_RESULT
      FOREIGN KEY (RESULT_ID)
      REFERENCES RESULT (ID)
   ON DELETE CASCADE;

ALTER TABLE WARNING
  ADD CONSTRAINT FK_WARNING_INSPECTOR
      FOREIGN KEY (PACKAGE_NAME, INSPECTOR, RESULT_ID)
      REFERENCES INSPECTOR (PACKAGE_NAME, NAME, RESULT_ID)
   ON DELETE CASCADE;

ALTER TABLE WARNING
  ADD CONSTRAINT FK_WARNING_RESULT
      FOREIGN KEY (RESULT_ID)
      REFERENCES RESULT (ID)
   ON DELETE CASCADE;

ALTER TABLE METRIC
  ADD CONSTRAINT "FK_METRIC_SQLC$E_RESULT"
      FOREIGN KEY (RESULT_ID)
      REFERENCES RESULT (ID)
   ON DELETE CASCADE;
